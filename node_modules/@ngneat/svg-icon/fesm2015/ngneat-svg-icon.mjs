...
class SvgIconRegistry {
    constructor(config) {
        ...
        if (config === null || config === void 0 ? void 0 : config.missingIconFallback) {
    ...
    get(key, config = {}) {
        ...
        if (!icon.init) {
            ...
            svg.setAttribute('preserveAspectRatio', (_a = config.preserveAspectRatio) !== null && _a !== void 0 ? _a : 'xMidYMid meet');
...
class SvgIconComponent {
    ...
    ngOnChanges(changes) {
        ...
        if ((_a = changes.size) === null || _a === void 0 ? void 0 : _a.currentValue) {
            this.setIconSize(this.mergedConfig.sizes[this.size]);
        }
        if ((_b = changes.fontSize) === null || _b === void 0 ? void 0 : _b.currentValue) {
            this.setIconSize(coerceCssPixelValue(this.fontSize));
        }
        // If on the first change no size was passed, set the default size
        if (!this.init && !((_c = changes.size) === null || _c === void 0 ? void 0 : _c.currentValue) && !((_d = changes.fontSize) === null || _d === void 0 ? void 0 : _d.currentValue)) {
            this.setIconSize(this.mergedConfig.sizes[this.mergedConfig.defaultSize || 'md']);
        }
        if ((_e = changes.width) === null || _e === void 0 ? void 0 : _e.currentValue) {
            this.element.style.width = `var(--svg-icon-width, ${coerceCssPixelValue(this.width)})`;
        }
        if ((_f = changes.height) === null || _f === void 0 ? void 0 : _f.currentValue) {
            this.element.style.height = `var(--svg-icon-height, ${coerceCssPixelValue(this.height)})`;
        }
        if ((_g = changes.color) === null || _g === void 0 ? void 0 : _g.currentValue) {
    ...
    createConfig() {
        ...
        const mergedConfig = Object.assign(Object.assign({}, defaults), this.config);
        mergedConfig.sizes = Object.entries(Object.assign(Object.assign({}, defaults.sizes), mergedConfig.sizes)).reduce((acc, [key, value]) => {
    ...
    setIcon(name) {
        ...
        const icon = (_a = this.registry.get(name, config)) !== null && _a !== void 0 ? _a : this.registry.get((_b = this.fallback) !== null && _b !== void 0 ? _b : (_c = this.config.missingIconFallback) === null || _c === void 0 ? void 0 : _c.name, config);
        if (icon) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.8", ngImport: i0, type: SvgIconComponent, decorators: [{
        ...
        return [{ type: i0.ElementRef }, { type: SvgIconRegistry }, { type: undefined, decorators: [{
                        type: Inject,
